...
class DefaultDataSeeder extends Seeder
{
    ...
    private function createJennie(User $admin): Celebrity
    {
        $c = Celebrity::firstOrCreate(['slug' => 'jennie'], [
            ...
            'category' => 'musician',
            'avatar' => \App\Models\Celebrity::avatarUrlFor('Jennie Kim'),
            'cover_photo' => \App\Models\Celebrity::coverUrlFor('jennie'),
            'gender' => 'female',
            'country' => 'South Korea',
            'is_active' => true,
            'created_by' => $admin->id,
    ...
    private function createJungkook(User $admin): Celebrity
    {
        $c = Celebrity::firstOrCreate(['slug' => 'jungkook'], [
            ...
            'category' => 'musician',
            'avatar' => \App\Models\Celebrity::avatarUrlFor('Jungkook'),
            'cover_photo' => \App\Models\Celebrity::coverUrlFor('jungkook'),
            'gender' => 'male',
            'country' => 'South Korea',
            'is_active' => true,
            'created_by' => $admin->id,
    ...
    private function createLisa(User $admin): Celebrity
    {
        $c = Celebrity::firstOrCreate(['slug' => 'lisa'], [
            ...
            'category' => 'musician',
            'avatar' => \App\Models\Celebrity::avatarUrlFor('Lisa'),
            'cover_photo' => \App\Models\Celebrity::coverUrlFor('lisa'),
            'gender' => 'female',
            'country' => 'South Korea',
            'is_active' => true,
            'created_by' => $admin->id,
