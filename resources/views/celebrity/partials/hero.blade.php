        ...
        <div class="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <div class="flex-1 text-center md:text-left space-y-4 md:space-y-8">
                ...
                <div class="flex flex-wrap justify-center md:justify-start gap-x-8 gap-y-3 pt-4">
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #fbbf24;">{{ count($tiers) }}+</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Membership Tiers</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #fbbf24;">10K+</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Fans Worldwide</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #fbbf24;">24/7</div>
            ...
            <div class="flex-1 flex justify-center">
                <div class="relative" x-data="sheenCard">
                    ...
                    <div class="relative w-64 h-64 md:w-96 md:h-96 rounded-3xl overflow-hidden shadow-2xl depth-card" style="box-shadow: 0 30px 80px -20px rgba(251,191,36,0.3); border: 1px solid rgba(255,255,255,0.1);">
    ...
    <div class="relative container-x w-full">
        <div class="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <div class="flex-1 text-center md:text-left space-y-4 md:space-y-8">
                ...
                <div class="flex flex-wrap justify-center md:justify-start gap-x-8 gap-y-3 pt-4">
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #f59e0b;">{{ count($tiers) }}+</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Membership Tiers</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #f59e0b;">10K+</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Fans Worldwide</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #f59e0b;">24/7</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Fan Support</div>
                    </div>
                </div>
            </div>
            <div class="flex-1 flex justify-center">
                <div class="relative" x-data="sheenCard">
                    ...
                    <div class="relative w-64 h-64 md:w-96 md:h-96 rounded-3xl overflow-hidden shadow-2xl depth-card" style="box-shadow: 0 30px 80px -20px rgba(217,119,6,0.25); border: 1px solid rgba(255,255,255,0.08);">
                        <div class="card-sheen" aria-hidden="true"></div>
                        @if ($celebrity->avatar)
                            <img src="{{ $celebrity->getAvatarUrl() }}" alt="{{ $celebrity->name }}" class="w-full h-full object-cover">
                        @else
    ...
    <div class="relative container-x w-full">
        <div class="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <div class="flex-1 text-center md:text-left space-y-4 md:space-y-8">
                ...
                <div class="flex flex-wrap justify-center md:justify-start gap-x-8 gap-y-3 pt-4">
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #ec4899;">{{ count($tiers) }}+</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Membership Tiers</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #ec4899;">10K+</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Fans Worldwide</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold" style="color: #ec4899;">24/7</div>
                        <div class="text-xs font-medium" style="color: rgba(255,255,255,0.5);">Fan Support</div>
                    </div>
                </div>
            </div>
            <div class="flex-1 flex justify-center">
                <div class="relative" x-data="sheenCard">
                    ...
                    <div class="relative w-64 h-64 md:w-96 md:h-96 rounded-3xl overflow-hidden shadow-2xl depth-card" style="box-shadow: 0 30px 80px -20px rgba(219,39,119,0.3); border: 1px solid rgba(236,72,153,0.15);">
                        <div class="card-sheen" aria-hidden="true"></div>
                        @if ($celebrity->avatar)
                            <img src="{{ $celebrity->getAvatarUrl() }}" alt="{{ $celebrity->name }}" class="w-full h-full object-cover">
                        @else
    ...
    <div class="relative container-x w-full">
        <div class="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <div class="flex-1 text-center md:text-left space-y-4 md:space-y-8">
                ...
                <div class="flex flex-wrap justify-center md:justify-start gap-x-8 gap-y-3 pt-4">
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold text-matte-accent" style="color: var(--accent-deep);">{{ count($tiers) }}+</div>
                        <div class="text-xs font-medium" style="color: rgba(0,0,0,0.5);">Membership Tiers</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold text-matte-accent" style="color: var(--accent-deep);">10K+</div>
                        <div class="text-xs font-medium" style="color: rgba(0,0,0,0.5);">Fans Worldwide</div>
                    </div>
                    <div class="text-center md:text-left">
                        <div class="text-xl md:text-2xl font-bold text-matte-accent" style="color: var(--accent-deep);">24/7</div>
                        <div class="text-xs font-medium" style="color: rgba(0,0,0,0.5);">Fan Support</div>
                    </div>
                </div>
            </div>

            <div class="flex-1 flex justify-center">
                <div class="relative animate-pulse-scale" x-data="sheenCard">
                    <div class="absolute inset-0 rounded-3xl opacity-30 blur-2xl" style="background: var(--accent); transform: scale(0.85);"></div>
                    <div class="relative w-64 h-64 md:w-96 md:h-96 rounded-3xl overflow-hidden shadow-2xl ring-2 ring-white/20 depth-card" style="box-shadow: 0 30px 80px -20px var(--accent-glow);">
                        <div class="card-sheen" aria-hidden="true"></div>
                        @if ($celebrity->avatar)
                            <img src="{{ $celebrity->getAvatarUrl() }}" alt="{{ $celebrity->name }}" class="w-full h-full object-cover">
